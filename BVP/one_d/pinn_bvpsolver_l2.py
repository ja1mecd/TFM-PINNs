...
class PINN_BVP_Solver:
    ...
    def train(
        ...
        # Learning-rate scheduler with exponential decay triggered on plateau
    ...
    def plot_results(self, n_plot_points=200):
        ...
        plt.tight_layout()
        out_path = os.path.join(FIG_DIR, "pinn_bvpsolver_l2.png")
...
def main():
    ...
    pinn.train(
        ...
        scheduler_gamma=0.9,
        scheduler_min_lr=1e-6,
        resample_every=500,  # <- keep same block for 500 epochs, then resample
    )
